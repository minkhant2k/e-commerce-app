...
///For Text Theme
const Color kTextColorForLightTheme = Colors.black;
const Color kTextColorForDarkTheme = Colors.white;

///For AppBar Theme
const Color kAppBarColorForLightTheme = Colors.black;
const Color kAppBarColorForDarkTheme = Colors.white;

///For BottomSheet Theme
const Color kBottomSheetColorForLightTheme = Colors.white;
const Color kBottomSheetColorForDarkTheme = Colors.black;

/// For Text Field Input decoration Theme
const Color kTextFieldPrefixIconColor = Colors.grey;
const Color kTextFieldSuffixIconColor = Colors.grey;

///default color light and dark
const Color kDarkMode = Colors.white;
const Color kLightMode = Colors.black;
...
const Color kDividerLightMode = Colors.black54;

/// colors for bottom nav bar
final Color kBotNavBarSelectItemColor = Colors.purple.shade300;
